...
- Check: `git log --oneline HEAD..origin/main -- <test-suite-map-file>`

### Service-module singletons
- Cross-cutting services (asset, project, release, intelligence) get many small additions.
- Check: `git diff origin/main...HEAD --name-only | grep '^lib/services/'`
...
- Check: `git log --oneline HEAD..origin/main -- CLAUDE.md` (or your equivalent)
